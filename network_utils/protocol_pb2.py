...
_TEST = _descriptor.Descriptor(
  name='Test',
  full_name='mygame_protocol.Test',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='mygame_protocol.Test.type', index=0,
...
_TEST.fields_by_name['type'].enum_type = _PROJECTILETYPE
...
class Test(_message.Message):
  ...
  # @@protoc_insertion_point(class_scope:mygame_protocol.Test)

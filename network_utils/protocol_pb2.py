...
_MESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stats', full_name='mygame_protocol.Message.stats', index=7,
...
_STATS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='mygame_protocol.Stats.type', index=0,
...
_MESSAGE.fields_by_name['stats'].message_type = _STATS
...
_STATS.fields_by_name['type'].enum_type = _PROJECTILETYPE
...
class WeaponStat(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType

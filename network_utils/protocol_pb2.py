...
_sym_db.RegisterEnumDescriptor(_PROJECTILETYPE)
...
_DIRECTION = _descriptor.EnumDescriptor(
  name='Direction',
  full_name='mygame_protocol.Direction',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='direction', full_name='mygame_protocol.MState.direction', index=10,
...
_PROJECTILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='playerHit', full_name='mygame_protocol.Projectile.playerHit', index=9,
      number=10, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEAPONSTAT = _descriptor.Descriptor(
  name='WeaponStat',
  full_name='mygame_protocol.WeaponStat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='playerId', full_name='mygame_protocol.WeaponStat.playerId', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wType', full_name='mygame_protocol.WeaponStat.wType', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fired', full_name='mygame_protocol.WeaponStat.fired', index=2,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='hit', full_name='mygame_protocol.WeaponStat.hit', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dmg', full_name='mygame_protocol.WeaponStat.dmg', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SCORESTAT = _descriptor.Descriptor(
  name='ScoreStat',
  full_name='mygame_protocol.ScoreStat',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='playerId', full_name='mygame_protocol.ScoreStat.playerId', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='score', full_name='mygame_protocol.ScoreStat.score', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STATS = _descriptor.Descriptor(
  name='Stats',
  full_name='mygame_protocol.Stats',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='sStat', full_name='mygame_protocol.Stats.sStat', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='wStat', full_name='mygame_protocol.Stats.wStat', index=1,
...
_MSTATE.fields_by_name['direction'].enum_type = _DIRECTION
_PROJECTILE.fields_by_name['type'].enum_type = _PROJECTILETYPE
_WEAPONSTAT.fields_by_name['wType'].enum_type = _PROJECTILETYPE
_STATS.fields_by_name['sStat'].message_type = _SCORESTAT
_STATS.fields_by_name['wStat'].message_type = _WEAPONSTAT
...
DESCRIPTOR.message_types_by_name['WeaponStat'] = _WEAPONSTAT
DESCRIPTOR.message_types_by_name['ScoreStat'] = _SCORESTAT
DESCRIPTOR.message_types_by_name['Stats'] = _STATS
DESCRIPTOR.enum_types_by_name['MessageType'] = _MESSAGETYPE
DESCRIPTOR.enum_types_by_name['ProjectileType'] = _PROJECTILETYPE
...
MState = _reflection.GeneratedProtocolMessageType('MState', (_message.Message,), dict(
  DESCRIPTOR = _MSTATE,
  __module__ = 'protocol_pb2'
  # @@protoc_insertion_point(class_scope:mygame_protocol.MState)
  ))
_sym_db.RegisterMessage(MState)
...
WeaponStat = _reflection.GeneratedProtocolMessageType('WeaponStat', (_message.Message,), dict(
  DESCRIPTOR = _WEAPONSTAT,
  __module__ = 'protocol_pb2'
  # @@protoc_insertion_point(class_scope:mygame_protocol.WeaponStat)
  ))
_sym_db.RegisterMessage(WeaponStat)

ScoreStat = _reflection.GeneratedProtocolMessageType('ScoreStat', (_message.Message,), dict(
  DESCRIPTOR = _SCORESTAT,
  __module__ = 'protocol_pb2'
  # @@protoc_insertion_point(class_scope:mygame_protocol.ScoreStat)
  ))
_sym_db.RegisterMessage(ScoreStat)

Stats = _reflection.GeneratedProtocolMessageType('Stats', (_message.Message,), dict(
  DESCRIPTOR = _STATS,
  __module__ = 'protocol_pb2'
  # @@protoc_insertion_point(class_scope:mygame_protocol.Stats)
  ))

...
class Camera(Events):
    ...
    def __init__(self, window):
        ...
        self.mpos = vec2(self.w, self.h)
        # y offset to have player in the lower half of the screen
        self.offset = vec2(0, -self.h / 2)
    ...
    def update(self, dt, state):
        ...
        #self.eas_vel.y -= (self.eas_vel.y - self.vel.y) * dt
    ...
    def set_camera(self):
        ...
        glLoadIdentity()
        glTranslatef(-self.campos.x + 2 * self.w,
                     -self.campos.y + self.h, 0)
